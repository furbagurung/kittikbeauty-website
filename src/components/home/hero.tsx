...
function PromoBannerGrid({ products }: { products: Product[] }) {
  return (
    <div className="w-full px-4 py-3 sm:px-6 lg:px-8">
      <div className="mx-auto grid w-full max-w-[1600px] grid-cols-2 gap-2 border-b border-stone-200 pb-3 lg:grid-cols-4 lg:gap-3">
...
function PromoCard({
  ...
  return (
    <Link href={card.href} className="group block overflow-hidden rounded-sm border border-stone-200 bg-white">
      ...
      <div className={`min-h-[104px] p-3 sm:min-h-[132px] sm:p-6 lg:min-h-[140px] ${card.blockClass}`}>
        ...
        <p className="mt-1 line-clamp-1 text-xs leading-4 opacity-95 sm:mt-2 sm:text-base sm:leading-6">{card.description}</p>
